...
/* Compiler settings for
   c:/Users/dblohm7/src/moz/other-licenses/ia2/AccessibleRelation.idl: Oicf, W1,
   Zp8, env=Win32 (32b run), target_arch=X86 8.00.0613 protocol : dce , ms_ext,
...
typedef struct IAccessibleRelationVtbl {
  ...
  ULONG(STDMETHODCALLTYPE* AddRef)(IAccessibleRelation* This);

  ULONG(STDMETHODCALLTYPE* Release)(IAccessibleRelation* This);
...
#        define IAccessibleRelation_get_localizedRelationType( \
            This, localizedRelationType)                       \
          ((This)->lpVtbl->get_localizedRelationType(This,     \
...
#        define IAccessibleRelation_get_targets(This, maxTargets, targets, \
                                                nTargets)                  \
