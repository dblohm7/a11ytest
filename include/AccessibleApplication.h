...
/* Compiler settings for
   c:/Users/dblohm7/src/moz/other-licenses/ia2/AccessibleApplication.idl: Oicf,
   W1, Zp8, env=Win32 (32b run), target_arch=X86 8.01.0620 protocol : dce ,
   ms_ext, app_config, c_ext, robust error checks: allocation ref bounds_check
   enum stub_data VC __declspec() decoration level:
...
typedef struct IAccessibleApplicationVtbl {
  ...
  ULONG(STDMETHODCALLTYPE* AddRef)(IAccessibleApplication* This);

  ULONG(STDMETHODCALLTYPE* Release)(IAccessibleApplication* This);
