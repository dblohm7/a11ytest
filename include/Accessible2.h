...
/* Compiler settings for
   c:/Users/dblohm7/src/moz/other-licenses/ia2/Accessible2.idl: Oicf, W1, Zp8,
   env=Win32 (32b run), target_arch=X86 8.00.0613 protocol : dce , ms_ext,
   app_config, c_ext, robust error checks: allocation ref bounds_check enum
   stub_data VC __declspec() decoration level:
...
typedef struct IAccessible2Vtbl {
  ...
  ULONG(STDMETHODCALLTYPE* AddRef)(IAccessible2* This);

  ULONG(STDMETHODCALLTYPE* Release)(IAccessible2* This);
  ...
  /* [id][propget][hidden] */ HRESULT(
      STDMETHODCALLTYPE* get_accKeyboardShortcut)(
      IAccessible2* This,
      /* [optional][in] */ VARIANT varChild,
...
#        define IAccessible2_GetIDsOfNames(This, riid, rgszNames, cNames,     \
                                           lcid, rgDispId)                    \
          ((This)->lpVtbl->GetIDsOfNames(This, riid, rgszNames, cNames, lcid, \
                                         rgDispId))

#        define IAccessible2_Invoke(This, dispIdMember, riid, lcid, wFlags, \
                                    pDispParams, pVarResult, pExcepInfo,    \
                                    puArgErr)                               \
          ((This)->lpVtbl->Invoke(This, dispIdMember, riid, lcid, wFlags,   \
                                  pDispParams, pVarResult, pExcepInfo,      \
                                  puArgErr))
...
#        define IAccessible2_get_accDescription(This, varChild, \
                                                pszDescription) \
...
#        define IAccessible2_get_accHelpTopic(This, pszHelpFile, varChild, \
                                              pidTopic)                    \
          ((This)->lpVtbl->get_accHelpTopic(This, pszHelpFile, varChild,   \
                                            pidTopic))

#        define IAccessible2_get_accKeyboardShortcut(This, varChild,      \
                                                     pszKeyboardShortcut) \
          ((This)->lpVtbl->get_accKeyboardShortcut(This, varChild,        \
                                                   pszKeyboardShortcut))
...
#        define IAccessible2_get_accDefaultAction(This, varChild,   \
                                                  pszDefaultAction) \
          ((This)->lpVtbl->get_accDefaultAction(This, varChild,     \
                                                pszDefaultAction))

#        define IAccessible2_accSelect(This, flagsSelect, varChild) \
          ((This)->lpVtbl->accSelect(This, flagsSelect, varChild))

#        define IAccessible2_accLocation(This, pxLeft, pyTop, pcxWidth, \
                                         pcyHeight, varChild)           \
          ((This)->lpVtbl->accLocation(This, pxLeft, pyTop, pcxWidth,   \
                                       pcyHeight, varChild))
...
#        define IAccessible2_get_relations(This, maxRelations, relations, \
                                           nRelations)                    \
          ((This)->lpVtbl->get_relations(This, maxRelations, relations,   \
                                         nRelations))
...
#        define IAccessible2_get_groupPosition(                     \
            This, groupLevel, similarItemsInGroup, positionInGroup) \
          ((This)->lpVtbl->get_groupPosition(                       \
              This, groupLevel, similarItemsInGroup, positionInGroup))
...
#        define IAccessible2_get_localizedExtendedRole(This,                  \
                                                       localizedExtendedRole) \
          ((This)->lpVtbl->get_localizedExtendedRole(This,                    \
                                                     localizedExtendedRole))

#        define IAccessible2_get_nExtendedStates(This, nExtendedStates) \
          ((This)->lpVtbl->get_nExtendedStates(This, nExtendedStates))

#        define IAccessible2_get_extendedStates(                      \
            This, maxExtendedStates, extendedStates, nExtendedStates) \
          ((This)->lpVtbl->get_extendedStates(                        \
              This, maxExtendedStates, extendedStates, nExtendedStates))

#        define IAccessible2_get_localizedExtendedStates(                \
            This, maxLocalizedExtendedStates, localizedExtendedStates,   \
            nLocalizedExtendedStates)                                    \
          ((This)->lpVtbl->get_localizedExtendedStates(                  \
              This, maxLocalizedExtendedStates, localizedExtendedStates, \
              nLocalizedExtendedStates))
